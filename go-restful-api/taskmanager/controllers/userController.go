...
import (
    ...
    "go-practice/go-restful-api/taskmanager/models"
)
...
func Register(w http.ResponseWriter, r *http.Request)  {
    ...
    // Clean-up the hashpassword to eliminate it form response
    ...
    if user, err := repo.Login(loginUser); err != nil {
        ...
        if err != nil {
            common.DisplayAppError(
                w,
                err,
                "An unexpected errors has occurred",
                500,
            )
            return
        }
