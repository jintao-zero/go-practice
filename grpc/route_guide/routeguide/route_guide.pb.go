...
// (degresss multiplied by 10**7 and rounded to the nearest integer).
...
type RouteGuideClient interface {
	...
	// streamed rather than returned at once (e.g. in a response
	// message with a repeated field), as the rectangle may cover
	// a large area and contain a huge number of features.
